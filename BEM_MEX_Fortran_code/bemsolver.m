...
mex_id_ = 'bemsolver(i int[xx], i int[x], i double[xx], i int[x], i double[x], i double[xx], i double[xx], i int[x], o double*, i int[x], i int[x], i double[x], o int[x], o double[x])';
[xval, iter, relres] = BEM(mex_id_, t2p, nt, p, np, reg, rs, js, nc, nquad, iprec, dnear, 3, nt, 1, 3, np, 1, nt, 3, nc, 3, nc, 1, 2, 2, 1, 1, 1);
